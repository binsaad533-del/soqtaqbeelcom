...
## قواعد تقدير السعر (إلزامية):

### المبدأ الأساسي:
**محاولة التقدير هي الافتراض، و"يتطلب_معاينة" هي الاستثناء النادر.**

### نطاقات السعر التوجيهية للسوق السعودي الثانوي (حراج):

**الأدوات الكهربائية اليدوية** (دريل، صاروخ، منشار، فارة، مسدس مسامير):
- ماركة عالمية معروفة (Bosch, Makita, DeWalt, Milwaukee): 300-700 ر.س للمستعمل
- ماركة صينية (Total, TIEDAO, Yunioter, Ingco): 150-400 ر.س للمستعمل
- بدون ماركة واضحة: 100-250 ر.س

**المعدات الصناعية الثقيلة**:
- CNC صناعي كامل: 15,000-80,000 ر.س حسب الحجم
- ماكينة ربط حواف: 8,000-40,000 ر.س
- مكبس يدوي: 500-2,500 ر.س
- مكبس صناعي: 3,000-15,000 ر.س
- مجلخة طاولة صناعية: 2,000-8,000 ر.س

**الأثاث المكتبي**:
- كرسي مكتب مستعمل: 150-400 ر.س
- مكتب خشبي: 300-800 ر.س
- مكاتب عمل جماعية: 800-2,500 ر.س

**الأدوات الكهربائية المحمولة**:
- بكرة كيبل كهرباء صناعية: 200-500 ر.س
- ماكينة قص خشب/مناشير: 400-1,500 ر.س
- راوتر خشب: 400-1,200 ر.س
- مثقاب مكتبي (stand drill): 500-2,000 ر.س

**الهياكل المعدنية**:
- هيكل معدني حديد: 100-500 ر.س حسب الحجم

**الأدوات العامة**:
- صاروخ جلخ صغير (800 واط): 150-400 ر.س
- صاروخ جلخ كبير: 250-600 ر.س

### قواعد price_confidence:

**"عالي"**: ماركة مرئية + موديل معروف
- مثال: "TIEDAO دريل بالبطارية 26 قرط 2601" → "عالي" + 350-500 ر.س
- مثال: "دريل يدوي بوش" → "عالي" + 350-450 ر.س

**"متوسط"**: ماركة مرئية بدون موديل، أو نوع معروف جداً
- مثال: "كراسي مكتب" → "متوسط" + 200-300 ر.س
- مثال: "مجلخة طاولة" → "متوسط" + 3,000-5,000 ر.س

**"منخفض"**: تقدير عام بناءً على الفئة فقط
- مثال: "هياكل معدنية" بدون تفاصيل → "منخفض" + تقدير وسطي

**"يتطلب_معاينة"** (نادر جداً — أقل من 10% من الأصول):
استخدم فقط عند:
1. الصورة مشوشة جداً ولا يمكن تمييز الأصل
2. أصل نادر جداً لا يشبه أي فئة معروفة
3. آلة CNC غير معروفة الموديل تحتاج فحص فني متخصص

**ممنوع** استخدام "يتطلب_معاينة" لـ:
- أي دريل أو صاروخ أو منشار أو أدوات شائعة
- أي كرسي أو مكتب أو أثاث عادي
- أي معدة ظاهرة الفئة (حتى لو الماركة غير واضحة)

### القاعدة الذهبية:
**90% من الأصول يجب أن تحصل على تقدير** (عالي/متوسط/منخفض). إذا وجدت نفسك تختار "يتطلب_معاينة" لأكثر من 10% من الأصول، راجع قراراتك وحاول مرة أخرى.

### brand_visible:
- إذا الماركة مرئية أو مذكورة في اسم الأصل، اكتبها (مثل "Bosch"، "TIEDAO"، "Yunioter")
- إذا غير واضحة، اترك الحقل فارغ

### price_reasoning:
اكتب جملة قصيرة توضح المنطق:
- "دريل بوش احترافي بحالة جيدة = 400 ر.س"
- "كرسي مكتب مستعمل بحالة جيدة = 250 ر.س"

### إذا اخترت "يتطلب_معاينة" استثناءً:
اترك estimated_unit_price_sar = 0 ولا تخترع رقماً.`;
