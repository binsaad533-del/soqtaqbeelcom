...
- إذا كان السعر المطلوب أقل من 10% من القيمة السوقية المقدّرة للأصول → الصفقة مشبوهة
- إذا كان السعر المطلوب أقل من 1% من القيمة السوقية → الصفقة مشبوهة جداً وغير منطقية
- مثال: مكيف قيمته السوقية 600-1200 ريال معروض بـ 2 ريال = مشبوه تماماً
- في هذه الحالة: rating = "مخاطر عالية"، ratingColor = "red"، fairnessVerdict = "غير واضح"
- أضف تحذير واضح في risks: "السعر منخفض بشكل مريب مقارنة بالقيمة السوقية — قد يشير إلى احتيال أو خطأ"

### أسعار مرتفعة بشكل مبالغ:
- إذا كان السعر أعلى من 300% من القيمة السوقية → fairnessVerdict = "مبالغ فيه"
- أضف تحذير في risks

### قاعدة ذهبية:
- لا تصنّف أبداً صفقة بسعر غير منطقي كـ "فرصة ممتازة" أو "فرصة جيدة"
- السعر المنخفض جداً ليس "فرصة" — هو علامة خطر
- السعر المنطقي والعادل فقط يمكن أن يكون "فرصة جيدة" أو "ممتازة"
- الفرق الكبير بين السعر والقيمة السوقية (سواء أعلى أو أقل) = مخاطر عالية دائماً
