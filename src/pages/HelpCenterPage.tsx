...
import { Search, HelpCircle, Store, Shield, FileText, MessageCircle, CreditCard, Settings } from "lucide-react";
...
const categories: FaqCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "ما هو مؤشر الشفافية؟", a: "مؤشر الشفافية يقيس مدى اكتمال بيانات إعلانك من 0 إلى 100. كلما أضفت تفاصيل أكثر (صور، مستندات، بيانات مالية) ارتفعت النسبة وزادت ثقة المشتري." },
