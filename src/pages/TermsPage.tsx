        ...
        <div className="space-y-6 text-sm text-foreground/85 leading-relaxed">
          ...
          <Section id="dispute" title="12. حل النزاعات">
            <ul className="list-disc pr-5 space-y-1 mt-1">
              ...
              <li>في حال عدم التوصل لحل ودي، يختص القضاء السعودي بالنظر في النزاع.</li>
          ...
          <Section id="law" title="14. القانون المُطبّق">
            تخضع هذه الشروط لأنظمة المملكة العربية السعودية، بما فيها نظام التجارة الإلكترونية ونظام مكافحة الاحتيال المالي وخيانة الأمانة ونظام حماية البيانات الشخصية. يختص القضاء السعودي بالنظر في أي نزاع ينشأ عن استخدام المنصة.
          </Section>
