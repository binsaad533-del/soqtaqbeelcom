...
const steps = [
  ...
  },
  {
    ...
    desc: "يقوم المشتري (العميل) بتحويل مبلغ العمولة إلى الحساب البنكي الموضح أدناه.",
  },
  {
    icon: ShieldCheck,
...
const faqs = [
  {
    q: "من يدفع العمولة؟",
    a: "المشتري (العميل) هو المسؤول عن دفع عمولة المنصة بعد إتمام الصفقة بنجاح.",
  },
  {
  ...
  },
  {
    ...
    a: "مبلغ العمولة المعروض لا يشمل ضريبة القيمة المضافة. يتحمل المشتري (العميل) أي ضرائب مطبقة حسب الأنظمة.",
  },
  {
