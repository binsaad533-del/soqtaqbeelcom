...
const dealTypes = [
  ...
  { id: "بيع_معدات", label: "بيع معدات" },
  { id: "بيع_مع_سجل", label: "بيع مع سجل" },
  { id: "بيع_بدون_سجل", label: "بيع بدون سجل" },
];

const cities = ["الكل", "📍 بالقرب مني", "الرياض", "جدة", "الدمام", "مكة", "المدينة"];

const activities = ["الكل", "مطاعم", "كافيهات", "صالونات", "ورش", "محلات", "بقالات", "مكاتب"];
