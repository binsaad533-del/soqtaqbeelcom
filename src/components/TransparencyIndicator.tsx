...
const TIER_BADGE: Record<string, { badge: string; label: string }> = {
  trusted: { badge: "✓ موثوق", label: "هذا الإعلان يحمل شارة \"موثوق\" — الإعلانات الموثوقة تحصل على تواصل أكثر بـ 3 أضعاف" },
  yellow: { badge: "⚠ يحتاج تحسين", label: "إكمال بعض الحقول يمنح الإعلان شارة \"موثوق\" وترتيبًا أعلى في نتائج البحث" },
  orange: { badge: "⚠ ضعيف", label: "إضافة المزيد من البيانات والصور تحسّن ظهور الإعلان وتبني ثقة المشتري" },
